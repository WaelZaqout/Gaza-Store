...
<body>
    ...
    <!-- Subtotal -->
        ...
        <form action="{{ route('checkout.process') }}" method="POST" id="payment-form">
            ...
            <!-- زر الدفع الإلكتروني -->
            <button type="submit" onclick="setPaymentMethod('online')">Checkout (Online Payment)</button>

            <!-- زر الدفع عند التسليم -->
            <button type="submit" onclick="setPaymentMethod('cod')">Checkout (Cash on Delivery)</button>
        </form>
