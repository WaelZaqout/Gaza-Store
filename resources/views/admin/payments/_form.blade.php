...
<div class="row">
    <div class="col-md-6">
        <div class="mb-3">
            ...
            <input type="text" name="name_en" class="form-control @error('name_en')
             is-invalid  @enderror"
                placeholder="English Name" value="{{ old('name_en', $payment->name_en) }}" />
    ...
    <div class="col-md-6">
        <div class="mb-3">
            ...
            <div class="gallery-wrapper">
                ...
                @foreach ($payment->gallery as $item)
                <div>
            ...
            @php
                $url = '';
                if ($payment->img_path) {
                    $url = asset('images/' . $payment->img_path);
                }
            @endphp
            @if($url)
    ...
    <div class="col-md-6">
        <div class="mb-3">
            ...
            is-invalid  @enderror"
                placeholder="English Description" rows="4">{{ old('description_en', $payment->description_en) }}</textarea>
    ...
    <div class="col-md-6">
        <div class="mb-3">
            ...
            is-invalid  @enderror"
                placeholder="Arabic Description" rows="4">{{ old('description_ar', $payment->description_ar) }}</textarea>
    ...
    <div class="col-md-4">
        <div class="mb-3">
            ...
            <input type="number" name="price" class="form-control @error('price')
             is-invalid  @enderror"
                placeholder="Price" value="{{ old('price', $payment->price) }}" />
        ...
        <div class="mb-3">
            ...
            <input type="number" name="quantity"
             ...
             is-invalid  @enderror" placeholder="Quantity"
                value="{{ old('quantity', $payment->quantity) }}" />
