...
@section('content')
    ...
    <!-- Page Heading -->
    <h1 class="h3 mb-4 text-gray-800">Edit silders</h1>

    <form action="{{ route('admin.silders.update', $silder->id) }}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT') <!-- أو PATCH -->
        @include('admin.silders._form')
