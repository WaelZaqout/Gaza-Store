...
@section('content')
    ...
    <tr>
        ...
        <td>{{ $order->payment ? $order->payment->status : 'pending' }}</td>
        <td>{{ $order->created_at->format('Y-m-d H:i') }}</td>
        <td>{{ $order->updated_at->format('Y-m-d H:i') }}</td>
        <td>

            <a class="btn btn-sm btn-primary" href="{{ route('admin.orders.edit', $order->id) }}"><i class="fas fa-edit"></i></a>
            ...
            <a class="btn btn-sm btn-primary" href=""><i class="fas fa-info-circle"></i></a>
